...
f_plasmid_cai =  read.csv('../data/F-plasmid/F-plasmid-CAI.tsv', 
                          sep='\t',
                          header=T)
...
f_plasmid_genes = read.csv('../data/F-plasmid/F-plasmid-genes-NCBI.tsv',
...
ggsave(file='../figures/Fig6/fig6-F-plasmid-panel2.pdf', width=7, height=5, p.F.plasmid)

ggsave(file='../figures/Fig6/fig6-F-plasmid-with-legend.pdf', p.CAI)
...
pdf('../figures/Fig6/fig6-F-plasmid-circular-panel-1.pdf', width=5, height=5)
circos.clear()
plasmid_length = 99159
